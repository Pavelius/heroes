...
static struct castles_list : public list
{
    ...
    void prerender()
    {
        ...
        if(!world::get(Player))
            return;
        tokens player = tokens(world::get(Player));
    ...
    else
    {
        ...
        case Resource:
            if(true)
            {
                ...
                draw::text(x + 122-draw::textw(temp)/2, y + 31, temp); // gold
                sznum(temp, player::gcost(world::get(Player)).get(Wood));
                draw::text(x + 14-draw::textw(temp)/2, y + 61, temp); // wood
                sznum(temp, player::gcost(world::get(Player)).get(Mercury));
                draw::text(x + 35-draw::textw(temp)/2, y + 61, temp); // mercury
                sznum(temp, player::gcost(world::get(Player)).get(Ore));
                draw::text(x + 59-draw::textw(temp)/2, y + 61, temp); // ore
                sznum(temp, player::gcost(world::get(Player)).get(Sulfur));
                draw::text(x + 82-draw::textw(temp)/2, y + 61, temp); // sulfur
                sznum(temp, player::gcost(world::get(Player)).get(Crystal));
                draw::text(x + 106-draw::textw(temp)/2, y + 61, temp); // crystal
                sznum(temp, player::gcost(world::get(Player)).get(Gems));
                draw::text(x + 128-draw::textw(temp)/2, y + 61, temp); // gems
            }
            break;
        case Hero:
...
//        draw::rectb(xp, yp, xp+32, yp+32, 0xC4);
        ...
        {
            if(bsget(id, Player)==world::get(Player))
