...
} objects[LastSpell - FirstSpell + 1] =
{
	...
	{{"Resurrect", "Оживление"}, 12, 4, 13, 50, {"Resurrects creatures from a damaged or dead unit until end of combat."}},
	{{"Resurrect True", "Истинное оживление"}, 15, 5, 12, 50, {"Resurrects creatures from a damaged or dead unit permanently."}},
