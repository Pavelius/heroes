...
} objects[LastSpell - FirstSpell + 1] =
{
	...
	{{"Fireball", "Огненный шар"}, 9, 3, 8, 1, {"Causes a giant fireball to strike the selected area, damaging all nearby creatures."}},
	...
	{{"Cure", "Лечение"}, 6, 1, 6, 5, {"Removes all negative spells cast upon one of your units, and restores up to %1 HP per level of spell power."}},
	{{"Mass Cure", "Общее лечение"}, 15, 3, 2, 5, {"Removes all negative spells cast upon your forces, and restores up to %1 HP per level of spell power, per creature."}},
	{{"Resurrect", "Воскрешение"}, 12, 4, 13, 50, {"Resurrects creatures from a damaged or dead unit until end of combat."}},
	{{"Resurrect True", "Истинное воскрешение"}, 15, 5, 12, 50, {"Resurrects creatures from a damaged or dead unit permanently."}},
	{{"Haste", "Ускорение"}, 3, 1, 14, 0, {"Increases the speed of any creature by %1."}},
	{{"Mass Haste", "Общее ускорение"}, 10, 3, 14, 0, {"Increases the speed of all of your creatures by %1."}},
	{{"Slow", "Замедление"}, 3, 1, 1, 0, {"Slows target to half movement rate."}},
	{{"Mass Slow", "Общее замедление"}, 15, 4, 1, 0, {"Slows all enemies to half movement rate."}},
	//
	{{"Blind", "Ослепление"}, 6, 2, 21, 0, {"Clouds the affected creatures' eyes, preventing them from moving."}},
	{{"Bless", "Благословение"}, 3, 1, 7, 0, {"Causes the selected creatures to inflict maximum damage."}},
	...
	{{"Animate Dead", "Анимировать мертвых"}, 10, 3, 25, 50, {"Resurrects creatures from a damaged or dead undead unit permanently."}},
	{{"Mirror Image", "Зеркальное отображение"}, 25, 5, 26, 0, {"Creates an illusionary unit that duplicates one of your existing units.  This illusionary unit does the same damages as the original, but will vanish if it takes any damage."}},
	{{"Shield", "Щит"}, 3, 1, 15, 2, {"Halves damage received from ranged attacks for a single unit."}},
	{{"Mass Shield", "Общй щит"}, 7, 4, 15, 0, {"Halves damage received from ranged attacks for all of your units."}},
	...
	{{"Dimension Door", "Дверь между измерениями"}, 10, 5, 47, 0, {"Allows the caster to magically transport to a nearby location."}},
	...
	{{"Set Earth Guardian", "Установить земляных стражей"}, 15, 4, 52, 4, {"Sets Earth Elementals to guard a mine against enemy armies."}},
	{{"Set Air Guardian", "Установить воздушных стражей"}, 15, 4, 53, 4, {"Sets Air Elementals to guard a mine against enemy armies."}},
	{{"Set Fire Guardian", "Установить огненных стражей"}, 15, 4, 54, 4, {"Sets Fire Elementals to guard a mine against enemy armies."}},
	{{"Set Water Guardian", "Установить водяных стражей"}, 15, 4, 55, 4, {"Sets Water Elementals to guard a mine against enemy armies."}},
