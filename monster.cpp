...
} objects[LastMonster - FirstMonster + 1] =
{
	...
	{2, 0, 5, 3, 2, 3, 10, Average, 8, 24, {"Ranger", "Рейнджер"}, {"Rangers", "Рейнджеров"}, {200, 0, 0, 0, 0, 0, 0}},
	{2, 0, 5, 9, 3, 4, 15, Average, 5, 0, {"Pikeman", "Копейщик"}, {"Pikemen", "Копейщиков"}, {200, 0, 0, 0, 0, 0, 0}},
	{2, 0, 5, 9, 3, 4, 20, Fast, 5, 0, {"Veteran Pikeman", "Ветеран копейщик"}, {"Veteran Pikemen", "Ветеранов копейщиков"}, {250, 0, 0, 0, 0, 0, 0}},
	{3, 0, 7, 9, 4, 6, 25, Average, 4, 0, {"Swordsman", "Мечник"}, {"Swordsmen", "Мечников"}, {250, 0, 0, 0, 0, 0, 0}},
	{3, 0, 7, 9, 4, 6, 30, Fast, 4, 0, {"Master Swordsman", "Мастер мечник"}, {"Master Swordsmen", "Мастеров мечников"}, {300, 0, 0, 0, 0, 0, 0}},
	{3, 0, 10, 9, 5, 10, 30, VeryFast, 3, 0, {"Cavalry", "Кавалерист"}, {"Cavalries", "Кавалерии"}, {300, 0, 0, 0, 0, 0, 0}},
	{3, 0, 10, 9, 5, 10, 40, UltraFast, 3, 0, {"Champion", "Чемпион"}, {"Champions", "Чемпионов"}, {375, 0, 0, 0, 0, 0, 0}},
	{4, 0, 11, 12, 10, 20, 50, Fast, 2, 0, {"Paladin", "Паладин"}, {"Paladins", "Паладинов"}, {600, 0, 0, 0, 0, 0, 0}},
	{4, 0, 11, 12, 10, 20, 65, VeryFast, 2, 0, {"Crusader", "Крестоносец"}, {"Crusaders", "Крестоносцев"}, {1000, 0, 0, 0, 0, 0, 0}},
	//
	{1, 0, 3, 1, 1, 2, 3, Average, 10, 0, {"Goblin", "Гоблин"}, {"Goblins", "Гоблинов"}, {40, 0, 0, 0, 0, 0, 0}},
	{1, 0, 3, 4, 2, 3, 10, VerySlow, 8, 8, {"Orc", "Орк"}, {"Orcs"}, {140, 0, 0, 0, 0, 0, 0}},
	{2, 0, 3, 4, 3, 4, 15, Slow, 8, 16, {"Orc Chief", "Боевой орк"}, {"Orc Chiefs", "Боевых орков"}, {175, 0, 0, 0, 0, 0, 0}},
	{2, 0, 6, 2, 3, 5, 20, VeryFast, 5, 0, {"Wolf", "Волк"}, {"Wolves", "Волков"}, {200, 0, 0, 0, 0, 0, 0}},
	{3, 0, 9, 5, 4, 6, 40, VerySlow, 4, 0, {"Ogre", "Огр"}, {"Ogres", "Огров"}, {300, 0, 0, 0, 0, 0, 0}},
	{3, 0, 9, 5, 5, 7, 60, Average, 4, 0, {"Ogre Lord"}, {"Ogre Lords"}, {500, 0, 0, 0, 0, 0, 0}},
	{3, 0, 10, 5, 5, 7, 40, Average, 3, 8, {"Troll", "Тролль"}, {"Trolls", "Троллей"}, {600, 0, 0, 0, 0, 0, 0}},
	{3, 0, 10, 5, 7, 9, 40, Fast, 3, 16, {"War Troll"}, {"War Trolls"}, {700, 0, 0, 0, 0, 0, 0}},
	{4, 0, 12, 9, 12, 24, 80, Fast, 2, 0, {"Cyclops", "Циклоп"}, {"Cyclopes", "Циклопов"}, {750, 0, 0, 0, 0, 1, 0}},
	//
	...
	//
	{1, 0, 3, 1, 1, 2, 5, Average, 8, 8, {"Centaur", "Кентавр"}, {"Centaurs", "Кентавров"}, {60, 0, 0, 0, 0, 0, 0}},
	{2, 0, 4, 7, 2, 3, 15, VeryFast, 6, 0, {"Gargoyle", "Гаргулья"}, {"Gargoyles", "Гаргулей"}, {200, 0, 0, 0, 0, 0, 0}},
	...
	{3, 0, 7, 7, 4, 8, 40, Average, 3, 0, {"Roc", "Орел"}, {"Rocs", "Орлов"}, {400, 0, 0, 0, 0, 0, 0}},
	...
	//
	{1, 0, 4, 3, 2, 3, 4, Average, 8, 0, {"Skeleton", "Скелет"}, {"Skeletons", "Скелеты"}, {75, 0, 0, 0, 0, 0, 0}},
	{1, 1, 5, 2, 2, 3, 15, VerySlow, 6, 0, {"Zombie", "Зомби"}, {"Zombies", "Зомби"}, {150, 0, 0, 0, 0, 0, 0}},
	{2, 1, 5, 2, 2, 3, 25, Average, 6, 0, {"Mutant Zombie", "Зомби мутант"}, {"Mutant Zombies", "Зомби мутанты"}, {200, 0, 0, 0, 0, 0, 0}},
	{2, 0, 6, 6, 3, 4, 25, Average, 4, 0, {"Mummy", "Мумия"}, {"Mummies", "Мумии"}, {250, 0, 0, 0, 0, 0, 0}},
	...
	//
	{1, 0, 6, 1, 1, 2, 4, Fast, 4, 0, {"Rogue", "Бандит"}, {"Rogues", "Бандитов"}, {50, 0, 0, 0, 0, 0, 0}},
	{2, 0, 7, 6, 2, 5, 20, VeryFast, 4, 0, {"Nomad", "Кочевник"}, {"Nomads", "Кочевников"}, {200, 0, 0, 0, 0, 0, 0}},
	{3, 0, 8, 7, 4, 6, 20, Fast, 4, 0, {"Ghost", "Призрак"}, {"Ghosts", "Призраков"}, {1000, 0, 0, 0, 0, 0, 0}},
