...
} objects[LastArtifact-FirstArtifact+1] =
{
	...
	{0, SpellBless, 1, {"Snake-Ring", "Кольцо змеи"}, {"The %1 halves the casting cost of all your bless spells."}},
	{0, 0, 2, {"Ankh", "Анкх"}, {"The %1 doubles the effectiveness of all your resurrect and animate spells."}},
	{0, 0, 2, {"Book of Elements", "Книга элементов"}, {"The %1 doubles the effectiveness of all your summoning spells."}},
	{0, 0, 2, {"Elemental Ring", "Кольцо элементов"}, {"The %1 halves the casting cost of all summoning spells."}},
	{0, 0, 1, {"Holy Pendant", "Святой кулон"}, {"The %1 makes all your troops immune to curse spells."}},
	{0, 0, 1, {"Pendant of Free Will", "Амулет свободной воли"}, {"The %1 makes all your troops immune to hypnotize spells."}},
	{0, 0, 1, {"Pendant of Life", "Кулон движения"}, {"The %1 makes all your troops immune to death spells."}},
	{0, 0, 1, {"Serenity Pendant", "Амулет спокойствия"}, {"The %1 makes all your troops immune to berserk spells."}},
	{0, 0, 1, {"Seeing-eye Pendant"}, {"The %1 makes all your troops immune to blindness spells."}},
	{0, 0, 1, {"Kinetic Pendant","Кулон движения"}, {"The %1 makes all your troops immune to paralyze spells."}},
	...
	{2, SpellPoints, 2, {"Power Ring","Кольцо Могущества"}, {"The %1 returns %2i extra power points/turn to your hero."}},
	{0, 0, 2, {"Ammo Cart"}, {"The %1 provides endless ammunition for all your troops that shoot."}},
	{-250, Gold, -1, {"Tax Lien", "Подать"}, {"The %1 costs you %2i gold pieces/turn."}},
	{0, 0, -1, {"Hideous Mask","Ужасная маска"}, {"The %1 prevents all 'wandering' armies from joining your hero."}},
	{1, Sulfur, 3, {"Endless Pouch of Sulfur", "Бесконечный мешочек Серы"}, {"The %1 provides %2i unit of sulfur per day."}},
	{1, Mercury, 3, {"Endless Vial of Mercury", "Бесконечный сосуд Ртути"}, {"The %1 provides %2i unit of mercury per day."}},
	{1, Gems, 3, {"Endless Pouch of Gems", "Бесконечный мешочек Драгоценностей"}, {"The %1 provides %2i unit of gems per day."}},
	{1, Wood, 2, {"Endless Cord of Wood", "Бесконечная вязанка Дерева"}, {"The %1 provides %2i unit of wood per day."}},
	{1, Ore, 2, {"Endless Cart of Ore", "Бесконечная тачка Камней"}, {"The %1 provides %2i unit of ore per day."}},
	{1, Crystal, 3, {"Endless Pouch of Crystal", "Бесконечный мешочек Кристаллов"}, {"The %1 provides %2i unit of crystal/day."}},
	{1, AttackDefence, 2, {"Spiked Helm", "Шипастый шлем"}, {"The %1 increases your attack and defense skills by %2i each."}},
	{2, AttackDefence, 3, {"Spiked Shield", "Шипастый щит"}, {"The %1 increases your attack and defense skills by %2i each."}},
	{1, SpellPowerWisdow, 2, {"White Pearl", "Белая жемчужина"}, {"The %1 increases your spell power and knowledge by %2i each."}},
	{2, SpellPowerWisdow, 3, {"Black Pearl", "Черная жемчужина"}, {"The %1 increases your spell power and knowledge by %2i each."}},
	//
	{0, 0, 0, {"Magic Book"}, {"The %1 enables you to cast spells."}},
};
static bsmeta::field fields[] = {
	BSREQ(artifact, type, Type, Number),
	BSREQ(artifact, effect, Value, Number),
	BSREQ(artifact, level, Level, Number),
	BSREQ(artifact, name, Name, Text),
	BSREQ(artifact, description, Text, Text),
};
BSMETA(artifact, "Artifacts", "Артифакты", FirstArtifact);