...
struct drawable
{
	...
	virtual void		painting(point position, unsigned flags) const = 0; // How to paint drawable.
...
void					dwpaint(drawable** da, rect screen, point camera, unsigned flags = 0); // Calling painting() for each drawable in list.
